...
* 🏆🪖⚔️ [複雜戰略模擬](07-07-complex_strategic_simulation.zh-hant.md)：自 **2020 年代**起，產業級應用於軍事與災害應變模擬，驗證策略並為「具身派」AI 提供 **軍民兩用** 的**世界模型**與**虛實組合**訓練框架。
...
    - 代表案例： [OpenAI Five 的 Dota 遊戲](07-05-openai_five.zh-hant)、處理複雜戰場感知的 [戰略模擬](07-07-complex_strategic_simulation.zh-hant.md)。
