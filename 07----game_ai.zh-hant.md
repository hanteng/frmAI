...
它不僅是娛樂或比賽的工具，更是人工智慧研究的重要試驗場；遊戲環境通常具備「**明確規則**」、「**可重複實驗**」、「**可量化評估**」特性，使其成為驗證**演算法**與系統設計的理想平台。
...
* 🏆🐭🗺️ [IEEE電子老鼠走迷宮](07-01-ieee_micromouse.zh-hant.md)：自 **1977 年**起，作為微型機器人比賽，驗證路徑規劃與感測器融合技術。
* 🏆🕹️👾 [Atari DQN](07-02-atari_dqn.zh-hant.md)：**2013 年**，DeepMind 以深度 Q 網路在多款 Atari 遊戲中達到人類水準，開啟深度強化學習新篇章。
* 🏆⚪⚫ [AlphaGo 圍棋](07-03-alphago.zh-hant.md)：**2016 年**，以深度神經網路與蒙地卡羅樹搜尋結合，擊敗世界冠軍李世乭。
* 🏆🃏💰 [撲克 AI](07-04-poker_ai.zh-hant.md)：**2017–2019 年**，在無限注德州撲克中擊敗頂尖職業選手，處理不完全資訊賽局的里程碑。
* 🏆🧙‍♂🥷 [OpenAI Five](07-05-openai_five.zh-hant.md)：**2018–2019 年**，在多人即時戰略遊戲（Dota 2）中擊敗世界冠軍隊伍，展現多智能體協作能力。
* 🏆🐺🧑‍🌾 [狼人殺 AI](07-06-werewolf_ai.zh-hant.md)：**2020 年**，在語言推理與社交博弈中達到高勝率，凸顯[語言賽局](01-07-Language_Games.zh-hant.md)的挑戰。
* 🏆🪖⚔️ [複雜戰略模擬](07-07-complex_strategic_simulation.zh-hant.md)：自 **2020 年代**起，產業級應用於軍事與災害應變模擬，驗證策略與資源分配演算法。

從早期的迷宮探索到今日的多智能體複雜戰略模擬，`「博弈派」AI` 的演進不僅映照了人工智慧技術的躍升，也為跨領域應用鋪設了策略性思考的基礎，為後續「新論」的探討奠定背景。
...
兩者互補合體的如🦾🧭🎯 [任務與目標規劃](08-06-robot_tasks_and_goals.zh-hant.md) 的應用，以及🏆🐭🗺️ [IEEE電子老鼠走迷宮](07-01-ieee_micromouse.zh-hant.md) 的實例。
...
- 🤖 **[多智能體系統](09-08-multi_agent_payoff_matrix.zh-hant)**  
    ...
    - 代表案例： [OpenAI Five 的 Dota 遊戲](07-05-openai_five.zh-hant)、處理複雜戰場感知的 [複雜戰略模擬](07-07-complex_strategic_simulation.zh-hant.md)。
