...
- 🧘⚕ **反思－符號心智**：具備長期互動學習與策略調整能力，能在任務規劃階段納入人類偏好與社會規範，並在長期使用中持續檢驗與修正互動模式，確保系統在不同情境下依然維持高品質的人機關係。
...
它必須同時處理技術與人文社會層面的挑戰，並在不同應用場景中靈活選擇研究方法與設計策略 @dautenhahn2013human。
