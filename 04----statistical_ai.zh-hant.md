...
| ---------------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| **1. 因果推論**      | 🏛️⊨∴ [形式邏輯](03-01-formal_logic.zh-hant) <br> 基於**演繹**推理，透過嚴謹規則追求絕對因果。                                     | 🌀🎲🌿 [機率性關聯](04-01-probabilistic_association.zh-hant) <br> 基於**歸納**推理，計算機率關聯，接受不確定性。                 |
| **2. 對話聊天實現**    | 🏛️🤖💬 [自動對話系統](03-02-automatic_dialogue_systems.zh-hant) <br> 依靠預設腳本與邏輯規則驅動對話。                           | 🌀🧞‍♀️🗪 [LLM 聊天機器人](04-02-llm_chatbots.zh-hant) <br> 依靠大型語言模型生成流暢且具脈絡的對話。                            |
| **3. 代表性里程碑**    | 🏛️🎁🧠 [專家系統](03-03-expert_systems.zh-hant) <br> 以專家知識＋邏輯規則構築可推理的知識庫。                                     | 🌀🪢🧠 [神經網路](04-03-neural_networks.zh-hant) <br> 從大量數據中自動學習高維關聯結構。                                    |
| **4. 過程工程實踐**    | 🏛️🛠️🏗️ [知識表徵](03-04-knowledge_representation.zh-hant) <br> 將**專家知識顯式編碼**為可推理、可檢索的結構。                    | 🌀🛠️🤏 [特徵工程](04-04-feature_engineering.zh-hant) <br> 從**數據**中萃取與構造**關鍵特徵**以優化模型。                     |
| **5. 經典模組半成品**   | 🏛️🕸💡 [知識圖譜](03-05-knowledge_graph.zh-hant) <br>以顯式概念與關係網路支援**知識演繹**與檢索。                                 | 🌀🤖📦 [機器學習模型](04-05-machine_learning_models.zh-hant) <br> 從**數據歸納模式**（包括隱含模式），產出可預測與分類的模型。           |
| **6. 網頁資訊科技**    | 🏛️🌐🔗 [語意網](03-06-semantic_web.zh-hant) <br> 以 RDF/OWL 構築語意網路，支援**跨系統**、**跨領域**知識**互操作**，體現**全球化知識生產力**。 | 🌀🌐🔗 [大語言模型網組合](04-06-llm_webassembly.zh-hant) <br> 在瀏覽器端本地推理與生成，支援網路化部署 LLM，體現**分散式知識生產力**。         |
| **7. 可計算知識表徵疆域** | 🏛️🌌🗺️ [本體論](03-07-ontology.zh-hant) <br> 定義**嚴謹結構化**的概念層級與關聯，確保一致性與可推理性，展現符號知識的**體系化知識生產力**。            | 🌀🌌▦ [向量空間](04-07-vector_space.zh-hant) <br> 捕捉語義關聯，學習隱含知識地圖，活用**數值化**與**幾何化**表徵，展現數據驅動的**體系化知識生產力**。 |
