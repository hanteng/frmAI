...
它聯繫抽象「思考」決策，以及具體的「行動」物理行為，使系統與世界互動，並不斷拓展在工業自動化、醫療服務、太空探索等領域的 AI 應用。實體驅動系統需要高度**整合硬體與軟體**，在控制與規劃上達到最佳效果，同時應對 **[符碼紮根問題](01-03-Symbol_Grounding_Problem.zh-hant)**（將抽象指令與具體動作聯繫）、**[框架問題](01-04-Frame_Problem.zh-hant)**（確定哪些物理狀態會改變）、以及 **[對齊與控制問題](01-06-AI_Alignment_Control_Problem.zh-hant)**（確保物理行為的安全與符合人類意圖）等核心挑戰。
