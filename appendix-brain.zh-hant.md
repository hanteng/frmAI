...
**鍛練**的有🌊[學習](#sec-cc-nouns) **名詞**«選項»，成體系的學習並實踐自己與世界，及其間關係的三觀認知。

人機**名詞**«選項»能細化 **協同關係**，成就**系統動態**編排，需要「行動〜**心智**〜能力」三連，將 AI 視為共同行動夥伴。
:::

> **心智**，億萬年來萬物能量交織而演生，鍛鑄出『**神經肌理**』；
> **機器**，今日以**世界能源**換得加速心智修行，如何看待『心智鍛鍊』的**獲益與代價**？
> 
> **修行**，乃是「知行之間」的叩問。**機器**能否鏡像並提煉這演化肌理？
> 我們在 AI 鍛鍊中，如何看透自身與機器的『**心智肌理**』？

接續前篇《💪[行動](appendix-action.zh-hant.md)》描述的**動詞**«選項»，本篇附錄集《🧠心智》專注於**名詞**«選項»，關照人類、機器、乃至世界萬物，是如何鍛鑄出『**神經肌理**』並看透自身與機器的『**心智肌理**』。

因此，**名詞**«選項»不只涉及世界萬物的實存，還包含相關的**人工智慧知識點**。本篇附錄集將這些**名詞**«選項»統整為個體對世界的『學習』內容、過程與成果，如同強調「在世實存」，為「入世實用」的『**神經肌理**』與『**心智肌理**』。
...
系統性認識關鍵核心名詞«選項»：
* 🔴 **核心圓**：人工智慧知識點，參照 **[🔖附錄🌌 心智圖](appendix-mindmap.zh-hant.qmd)**；
...
**鍛練**的對象還可以把本書目錄作為實例，本書目錄 可視為 AI 知識點的基礎結構，讀者可依需求自行增修，隨時補充最需要的部分。

目錄分為十章，共 66 條目。讀者可以複製一份作為模板，增刪調整，成為專屬的客製化知行鷹架。
...
* 🔴 **核心圓**：首先，運用本書總結提出的 `三重心智整合模型` （見下節），以系統思維觀照自身、環境、與世界，認識自身心智 「神經⚡肌肉」，是需要逐級「鍛練」的心智修行，進一步參與人工智慧的 [神經網路](04-03-neural_networks.zh-hant.md) 及 [赫布學習論](09-07-hebb_rule.zh-hant.md) 等等相關的**強化學習** 及 **深度學習** 的「鍛練」。
...
`三重心智整合模型`（Tri-Aspect Cognitive Model），指本書原創的`心智能力分類`，整合三大理論視角——「快思慢想」 [@sec-dual-process-theory]（認知科學）、[@sec-triune-brain-hypothesis]（神經學）、[@sec-social-brain-hypothesis]（演化與行為科學）的`三層心智能力分類法`，在本書簡稱`心智能力分類法`。

這套跨領域的**心智能力分類**，將人類的心智活動，依其**處理速度**、**社會功能**與**符號能力**，劃分為三種主要型態：
...
所需的 反應時間 和 **(@sec-cognitive-load)** 是依序升高，這三層心智，對應到 AI 的不同設計層次：
...
本書採用的「心智能力分類法」不僅是對生物心智的觀察與歸納，更是一種**人工智慧認知架構設計藍圖**。名詞«選項»在此轉化為設計藍圖，映射到時間與空間維度，成為 AI 問題意識的對應詞庫。
...
- 🤖 **機器學習**
    ...
    - 🔋 缺乏內在動機與情感，需外部設計**報酬函數**與**目標函數**，且能源消耗龐大。如**數據中心能耗**。訓練單一頂級 LLM 模型（如 GPT−4）所消耗的電力，可供數十戶家庭使用一年。
- 🔄 **對照與互補**
	- - ⚖️ 人類學習強調「有限能量下的深度修行」，機器學習則是「無限能源下的加速鍛鍊」。
...
- 🤖 **機器的世界模型**，或俗稱 **「腦內小地圖」**（AI 圈子裡有時戲稱為 **「世界 buff」** 或 **「stats 模擬器」**，也有人用「NPC 腦補包」來形容）：
...
- 例如，本書總結上述理論，提出 `三層心智能力分類法`，並和 🦾 「具身派」AI 進行對照，探討如何在「反應—情感—符號」三層次上鍛鍊 AI 的世界模型。        
...
我們從三大理論——⚡🧘 **雙系統假說**、🐸🐘🧘 **三重腦假說**、🤝🙊 **社會腦假說**——出發，建構出一個「三層心智能力分類法」，並將其映射到 AI 的設計藍圖：
