...
* 補強 👁️⯊ **[完形心理](01-05-Gestalt_Psychology.zh-hant)** 在語言方面的認知經驗法則 ，特別是對話時的回應「接話」。如此在分析 **[大語言模型](02-07-large_language_models.zh-hant)** 的應用時，特別是 **[脈絡工程](10-04-context_engineering.zh-hant)** ，就能具體分析涉及的參與者、賽局、相關性框架等等，區辨可利用及需避免的快思及慢想。
* 分析 🎯🛡️ **[AI 對齊問題](01-06-AI_Alignment_Control_Problem.zh-hant)** 中的多方利益，並尋求可控可解釋符合價值對齊的規則遵循（Rule-Following）。
[[]]
## ㉄ 意義如何生成？
