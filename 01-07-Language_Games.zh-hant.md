...
* 參閱 [🌀🧞‍♀️🗪 LLM 聊天機器人](@sec-llm-chatbots)，思考 LLM 實際 **使用** 情境 **脈絡**，如何從`語言賽局`對話時的回應「接話」獲得靈感啟發。
* 參閱 [🌉🛣🌐 脈絡工程](#sec-context-engineering)，思考 LLM 實際 **使用** 情境 **脈絡**，如何從`語言賽局`對話時的回應「接話」獲得靈感啟發，形成體系化的工程建構。
