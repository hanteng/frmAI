...
- 🏭🚗 **2000s：突破性原型與暗工廠概念成型**  
    ...
    - ↪️對應知識點：**8.3** 🦾🔄🖼️ [自適應機器人](08-03-adaptive_robotics.zh-hant.md) 走出實驗室；**8.5** 🦾🛡️🚨 [機器人安全與穩健性](08-05-robot_safety_and_robustness.zh-hant.md) 走入暗工廠  
- 🚚🤖 **2010s：商轉與大規模應用**  
    ...
    - ↪️對應知識點：**8.3** 🦾🔄🖼️ [自適應機器人](08-03-adaptive_robotics.zh-hant.md) 走進產業；**8.4** 🦾🤝💪 [人機互動](08-04-human_robot_interaction.zh-hant.md) 與 **8.5** 🦾🛡️🚨 [機器人安全與穩健性](08-05-robot_safety_and_robustness.zh-hant.md) 成為產業關鍵能力。  
- 🧞‍♀️🗪 **2020s–至今：虛擬代理與大模型耦合的認知挑戰**  
    ...
    - ↪️對應知識點：**8.5** 🦾🛡️🚨 [機器人安全與穩健性](08-05-robot_safety_and_robustness.zh-hant.md) 的智能體新興挑戰；**8.6** 🦾🧭🎯 [任務與目標規劃](08-06-robot_tasks_and_goals.zh-hant.md) 實踐與理論應對 [對齊與控制問題](01-06-Alignment_Control_Problem.zh-hant.md)  
