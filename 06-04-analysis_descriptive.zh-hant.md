...
- 📂**資料來源**：歷史紀錄、交易資料、感測器數據、問卷調查 (fill in here)等
- 🛠️**處理方式**：統計摘要、分佈分析、趨勢圖表、儀表板 (fill in here)
- 📊**輸出形式**：報表、可視化圖表、關鍵指標 (fill in here)（KPI）
...
* 決策鏈下一步（ **描述 ⮫🟡😷🩺 [診斷型分析](06-01-analysis_diagnostic.zh-hant.md) ⮫ [預測型分析](06-02-analysis_predictive.zh-hant.md) ⮫ [指導型分析](06-03-analysis_prescriptive.zh-hant.md)** ）
* 深究
