...
可以說，`描述型分析`對映到 **[布魯姆分類學](appendix_action.zh-hant.md)** 中的**記憶**（Remember）認知能力。差別在於前者是支持**組織**決策，後者是增強**個人**學習。
...
這進一步還突顯了[框架問題](01-04-Frame_Problem.zh-hant.md)的現代觀點「當下，啥才重要？」的相關性問題，要如何按決策情境有效篩選**事實**資料。因此需注意相關的創意加值亦有可能導致信息「偏聽」或「偏食」的問題。
