...
- 對映到如「_當下，啥才重要？_」 AI 的 [框架問題](01-04-Frame_Problem.zh-hant.md) 等問題意識。
...
可以說，`描述型分析`對映到 **[布魯姆分類學](appendix-action.zh-hant.qmd)** 中的**記憶**（Remember）認知能力。差別在於前者是支持**組織**決策，後者是增強**個人**學習。
...
這對個人認知能力亦有啟發性，對映到 **[布魯姆分類學](appendix-action.zh-hant.qmd)** 中的**記憶**：
...
參照 **[🔖附錄🌌 心智圖](appendix-mindmap.zh-hant.qmd)** 將`描述型分析`與下述概念對比，是否能被大致歸類到「描述世界」的範圍：
