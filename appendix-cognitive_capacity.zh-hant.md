...
* **建補**：從❝腦補❞到🙶補全🙷，**🌊[名詞](#sec-cc-nouns)➕🏄🏼[動詞](#sec-cc-verbs)** 的«**選項**»
...
- **MVP 內容**： 上線「**風格匹配算法** + **成果結構化輸出**」組合。專門解決「**課程匹配**」和「**作品集優化**」任務。
    * **課程匹配**：利用 **[協同過濾](09-01-collaborative_filtering.zh-hant.md)** 演算法，根據學生的**學習風格**（如視覺型、實踐型）和**當前知識缺口**，推薦最適合的**線上課程、書籍或實作專案**。
