...
`感知與環境` 是具身派 AI 的「感官」，理解周遭世界的基石。隨著**感應器技術**的進步和**機器學習**演算法的突破，具身 AI 的感知能力將會越來越接近人類，甚至在某些方面超越人類。這種能力不僅限於工業應用，也將在服務型機器人、自駕交通工具等領域發揮關鍵作用。將原始感測器數據轉化為有意義的環境表徵，為 AI 的決策、規劃和行動提供必要的資訊。準確、可靠的環境感知是實現機器人自主性、安全性和效率的先決條件，與[機器人學與實體驅動](08-01-robotics_and_physical_actuation.zh-hant) 、[人機互動](08-04-human_robot_interaction.zh-hant)、 [任務與目標規劃](08-06-robot_tasks_and_goals.zh-hant)、等領域緊密相連。當機器人能夠感知與理解環境後，它們還需要具備調整自身行為的能力，這就引出了下一章要探討的「**[自適應機器人學](08-03-adaptive_robotics.zh-hant)**」。

為了實現更強大的環境感知能力，AI 系統需要應對相關的 **[符碼紮根問題](01-03-Symbol_Grounding_Problem.zh-hant)**（如何聯繫感測數據與符號概念）、**框架問題**（如何聚焦重要資訊）、以及 **[完形心理](01-05-Gestalt_Psychology.zh-hant)**（如何在應用**認知捷徑**或**經驗法則**但同時避免誤判）。 透過結合深度學習、感測器融合、幾何推理等技術，AI 能夠更深入地理解周遭世界。
